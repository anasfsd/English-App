...
# when you deploy this code on github and finally on streamlit. YOU need to change these the api key setting code.
#you have to store the api key in secrets of streamlit provided in advanced settings
